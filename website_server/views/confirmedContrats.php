<?php
$nvContrats = getConfirmedContrats();
?>
        ...
        <div class="table-responsive p-3">
            <table class="table align-items-center table-flush" id="dataTable">
                <dl class="dl-horizontal">
                    ...
                    <tbody>
                        <?php
                        foreach ($nvContrats as $rec) {
                            extract($rec);
                            $stat = '';
                        ?>
                            <tr>
                                <td><?php echo $nom_societe; ?></td>
                                <td><?php echo $tel_societe; ?></td>
                                <td><a href="#"><?php echo $login_commercial; ?></a></td>
                                <td><span class="badge badge-<?php echo $contrat_type; ?>">
                                        <?php echo $contrat_type; ?>
                                    </span></td>
                                <td><a href="<?php echo WEB_ROOT; ?>views/?v=contrat&code_contrat=<?php echo $code_contrat; ?>" class="btn btn-sm btn-primary">détaille</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
